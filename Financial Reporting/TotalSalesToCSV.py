...
connection = odbc.connect("Driver = {SQL Server Native Client};"
                          "Server = prod-sql-cfieducation.database.windows.net;"
                          "Database = AdventureWorksDW;"
                          "uid= BI_User; pwd=CFI123456789!")


df = pd.read_sql_query('SELECT fs.SalesOrderNumber AS InvoiceNumber,fs.SalesOrderLineNumber AS InvoiceLineNumber,
